    ...
    return (
        <div className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 py-8 md:py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(200px,auto)]">
                ...
                {/* Availability Card */}
                <section className="col-span-12 md:col-span-7 lg:col-span-8 border-3 border-neo-border bg-white text-neo-text p-8 md:p-10 shadow-neo flex flex-col justify-between relative overflow-hidden group hover:shadow-neo-hover-lg hover:-translate-y-1 transition-all duration-300">
                ...
                {/* Direct Contact Card */}
                <section className="col-span-12 md:col-span-5 lg:col-span-4 border-3 border-neo-border bg-primary p-8 md:p-10 shadow-neo flex flex-col relative group hover:shadow-neo-hover-lg hover:-translate-y-1 transition-all duration-300">
                ...
                {/* Social Grid Header */}
                <section className="col-span-12 border-3 border-neo-border bg-secondary p-8 md:p-10 shadow-neo group hover:shadow-neo-hover-lg hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <a
                            ...
                            className="block border-3 border-black p-5 bg-white hover:bg-primary hover:text-black transition-all hover:shadow-[6px_6px_0px_0px_#000000] group/card h-full"
                        >
